import SmokyTargetShotCommandPacket from "../../packets/implementations/SmokyTargetShotCommandPacket";
import SmokyTargetShotPacket from "../../packets/implementations/SmokyTargetShotPacket";
...
export default class SmokyTargetShotCommandHandler implements IPacketHandler<SmokyTargetShotCommandPacket> {
  public readonly packetId = SmokyTargetShotCommandPacket.getId();

  public execute(client: ProTankiClient, server: ProTankiServer, packet: SmokyTargetShotCommandPacket): void {
    ...
    const targetShotPacket = new SmokyTargetShotPacket({
